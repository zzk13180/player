...
import type { Tag, TagEmit } from '@player/common/interfaces/shared-interfaces'

@Component({
  selector: 'app-view-tags-component',
  templateUrl: 'view-tags.component.html',
  styleUrls: ['../search.scss', 'view-tags.component.scss'],
})
export class ViewTagsComponent {
  ...
  constructor(public tagService: ManualTagsService) {}
