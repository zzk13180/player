...
import { historyItemRemove, slowFadeIn } from '../../animation/animations'
import type {
  AllowedScreenshotHeight,
  AllowedScreenshotHeightString,
} from '@player/common/interfaces/final-object.interface'
import type { HistoryItem } from '@player/common/interfaces/shared-interfaces'
...
export class WizardComponent {
  ...
  selectScreenshotSize(pxHeightForImport: AllowedScreenshotHeightString | string): void {
    const height: AllowedScreenshotHeight = parseInt(
      pxHeightForImport,
      10,
    ) as AllowedScreenshotHeight
