...
import { metaAppear, textAppear, modalAnimation } from '../../animation/animations'
...
export class SheetComponent implements OnInit {
  ...
  ngOnInit() {
    this.pathToFilmstripJpg = this.filePathService.createFilePath(
      this.folderPath,
      this.hubName,
      'filmstrips',
      this.video.hash,
    )
    this.pathToVideoFile = `${this.selectedSourceFolder}/${this.video.partialPath}/${this.video.fileName}`
    // path.join(
    //   this.selectedSourceFolder,
    //   this.video.partialPath,
    //   this.video.fileName,
    // )
